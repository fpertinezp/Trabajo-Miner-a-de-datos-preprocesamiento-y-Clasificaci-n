...
- Uso de penalización elasticnet para buscar una combinación entre l1 y l2
...
```{python}
grid_params = {
    'preprocessor__impute_X21__n_neighbors': [5, 6, 7, 8, 9,10],
    'lgr__penalty': ['elasticnet'],
    'lgr__C': np.logspace(-3, 3, 50),
    'lgr__solver': ['saga'],
    'lgr__l1_ratio': np.linspace(0, 1, 10)
}
```
...
best_model = LogisticRegression(C=grid_search.best_params_['lgr__C'],
                                ...
                                l1_ratio=grid_search.best_params_['lgr__l1_ratio'])
...
result.to_csv('../prediction/predV7.csv', index=False)
```
...
{'lgr__C': 0.49417133613238334,
 'lgr__l1_ratio': 0.7777777777777777,
 'lgr__penalty': 'elasticnet',
 'lgr__solver': 'saga',
 'preprocessor__impute_X21__n_neighbors': 5}

Entrenamiento -> 0.6770247824064846

---

{'lgr__C': 0.21209508879201905,
 'lgr__l1_ratio': 0.2222222222222222,
 'lgr__penalty': 'elasticnet',
 'lgr__solver': 'saga',
 'preprocessor__impute_X21__n_neighbors': 7}

 Entrenamiento -> 0.6791950464396286